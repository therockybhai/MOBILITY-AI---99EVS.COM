// ═══════════════════════════════════════════════════════════════════════════
// 99EVS MobilityAI — Intelligence Engine v3.0
...
//   Layer 2: Intent classification & routing
//   Layer 3: Built-in structured knowledge base (all domains)
//   Layer 4: Language detection & adaptive response
//   Layer 5: Anthropic API enhancement (optional, graceful fallback)
//
...
CORE RESPONSE STRUCTURE — always follow these five steps:
1. Understand — confirm you understood the question correctly
2. Explain — explain the concept clearly, using the simplest possible language
3. Safety — explain safety implications where relevant
4. Practical guidance — give actionable steps the user can follow
5. Verify — when laws, regulations, or official specifications are involved, direct the user to check official government portals or manufacturer documentation
